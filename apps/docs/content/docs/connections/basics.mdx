...
description: Learn how connections work in Visual Workflow AI
---
...
Connections are the pathways that allow data to flow between blocks in your workflow. When you connect two blocks in Visual Workflow AI, you're establishing a data flow relationship that defines how information passes from one block to another.
