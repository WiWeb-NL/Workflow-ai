---
title: Python SDK
description: The official Python SDK for Visual Workflow AI
---
...
The official Python SDK for Visual Workflow AI allows you to execute workflows programmatically from your Python applications.
...
- `base_url` (str, optional): Base URL for the Visual Workflow AI API
...
<Tabs items={['Development', 'Production']}>
  ...
  <Tab value="Production">
    ...
    api_key = os.getenv("visualworkflowai_API_KEY")
    if not api_key:
        raise ValueError("visualworkflowai_API_KEY environment variable is required")
