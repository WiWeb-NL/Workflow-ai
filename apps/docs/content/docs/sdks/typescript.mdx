...
description: The official TypeScript/JavaScript SDK for Visual Workflow AI
---
...
The official TypeScript/JavaScript SDK for Visual Workflow AI allows you to execute workflows programmatically from your Node.js applications, web applications, and other JavaScript environments.
...
<Steps>
  <Step title="Initialize the client">
    Set up the visualworkflowaiClient with your API key.
  </Step>
...
<Tabs items={['Development', 'Production']}>
  <Tab value="Development">
    ...
    const apiKey = process.env.visualworkflowai_API_KEY;
    if (!apiKey) {
      throw new Error('visualworkflowai_API_KEY environment variable is required');
    }
  ...
  <Tab value="Production">
    ...
    const client = new visualworkflowaiClient({
      apiKey,
      baseUrl: process.env.visualworkflowai_BASE_URL || 'https://visualworkflowai.ai'
    });
    ```
  </Tab>
</Tabs>
...
import { visualworkflowaiClient, WorkflowExecutionResult } from 'visualworkflowai-ts-sdk';

const client = new visualworkflowaiClient({
  apiKey: process.env.NEXT_PUBLIC_visualworkflowai_API_KEY!
});
...
<Steps>
  <Step title="Log in to Visual Workflow AI">
    Navigate to [Visual Workflow AI](https://visualworkflowai.ai) and log in to your account.
  </Step>
...
const client: visualworkflowaiClient = new visualworkflowaiClient({
  apiKey: process.env.visualworkflowai_API_KEY!
});
