...
<Callout type="info">
  Every workflow execution follows a deterministic path based on your block
  connections and logic, ensuring predictable and reliable results.
</Callout>
...
- Creates a unique HTTP endpoint: `https://visualworkflow.app/api/workflows/{workflowId}/execute`
...
- Hosted on a custom subdomain: `https://your-name.visualworkflow.app`
