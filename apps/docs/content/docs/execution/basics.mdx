...
description: Understanding the fundamental execution flow in Visual Workflow AI
---
...
When you run a workflow in Visual Workflow AI, the execution engine follows a systematic process to ensure blocks are executed in the correct order and data flows properly between them.
