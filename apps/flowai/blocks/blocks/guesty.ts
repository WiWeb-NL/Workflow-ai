...
import type {
  GuestyGuestResponse,
  GuestyReservationResponse,
} from "@/tools/guesty/types";
import type { BlockConfig } from "../types";

export const GuestyBlock: BlockConfig<
  GuestyReservationResponse | GuestyGuestResponse
> = {
  type: "guesty",
  name: "Guesty",
  ...
  tools: {
    ...
    config: {
      tool: (params) => {
        return params.action === "reservation"
          ? "guesty_reservation"
          : "guesty_guest";
      },
      params: (params) => {
