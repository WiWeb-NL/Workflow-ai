...
export const workflowExecutionLogs = pgTable(
  ...
  (table) => ({
    ...
    durationIdx: index("workflow_execution_logs_duration_idx").on(
...
export const workflowExecutionBlocks = pgTable(
  ...
  (table) => ({
    executionIdIdx: index("execution_blocks_execution_id_idx").on(
      table.executionId
    ),
    workflowIdIdx: index("execution_blocks_workflow_id_idx").on(
      table.workflowId
    ),
...
export const workspaceMember = pgTable(
  ...
  (table) => {
    return {
      ...
      userIdIdx: uniqueIndex("user_workspace_idx").on(
        table.userId,
        table.workspaceId
      ),
    };
