  ...
  return (
    <Html>
      ...
      <Body style={baseStyles.main}>
        <Preview>
          You've been invited to join the "{workspaceName}" workspace on Visual Workflow AI!
        </Preview>
        <Container style={baseStyles.container}>
          ...
          <Section style={baseStyles.content}>
            ...
            <Text style={baseStyles.paragraph}>
              {inviterName} has invited you to join the "{workspaceName}" workspace on Visual Workflow AI!
            </Text>
            <Text style={baseStyles.paragraph}>
              Visual Workflow AI is a powerful platform for building, testing, and optimizing AI workflows.
