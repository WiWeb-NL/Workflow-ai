    ...
    <div className="space-y-6 p-6">
      ...
      <div className="border-t pt-4">
        <p className="text-muted-foreground text-xs">
          We use OpenTelemetry to collect anonymous usage data to improve Visual
          Workflow AI. All data is collected in accordance with our privacy
          policy, and you can opt-out at any time. This setting applies to your
