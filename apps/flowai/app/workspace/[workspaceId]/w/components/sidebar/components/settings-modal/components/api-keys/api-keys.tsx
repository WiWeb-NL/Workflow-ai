  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <p className="text-muted-foreground text-sm leading-relaxed">
        API keys allow you to authenticate and trigger workflows. Keep your API
        keys secure. They have access to your account and workflows.
      </p>
      ...
      <Dialog open={isCreating} onOpenChange={setIsCreating}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Name your API key to help you identify it later. This key will
      ...
      >
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              This is the only time you will see your API key. Copy it now and
              store it securely.
            </DialogDescription>
          </DialogHeader>
          {newKey && (
