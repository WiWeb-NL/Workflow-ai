...
export const WorkspaceHeader = React.memo<WorkspaceHeaderProps>(
  ({ onCreateWorkflow, isCollapsed, onDropdownOpenChange }) => {
    ...
    const getPlanName = (
      subscription: ReturnType<typeof getSubscriptionStatus>
    ) => {
        ...
        >
          ...
          <DropdownMenuContent align="start" className="min-w-[224px] p-1">
            ...
            <div className="px-1 py-1">
              <div className="mb-1 pl-1 font-medium text-muted-foreground text-xs">
                Workspaces
              </div>
              {isWorkspacesLoading ? (
                            ...
                            <AlertDialog>
                              <AlertDialogTrigger asChild>
                                <Button
                                  ...
                                  disabled={
                                    isDeleting || workspaces.length <= 1
                                  }
                                >
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    ...
                                    {workspace.name}"? This action cannot be
                                    undone.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
