    ...
    <div className="space-y-4">
        ...
        <div className="flex items-center justify-between rounded-lg border border-border bg-background p-3 shadow-sm">
          <div className="flex items-center gap-2">
            ...
            <Tooltip>
              ...
              >
                <p className="text-sm">
                  Enable to receive the complete record data in the payload, not
                  just changes.
                </p>
              </TooltipContent>
            </Tooltip>
      ...
      <InstructionsSection tip="Airtable webhooks monitor changes in your base/table and trigger your workflow.">
        <ol className="list-inside list-decimal space-y-1">
          ...
          <li>
            Visual Workflow AI will automatically configure the webhook in your
            Airtable account when you save.
          </li>
          <li>
            Any changes made to records in the specified table will trigger this
            workflow.
          </li>
          <li>
            If 'Include Full Record Data' is enabled, the entire record will be
            sent; otherwise, only the changed fields are sent.
          </li>
        </ol>
      </InstructionsSection>
    </div>
