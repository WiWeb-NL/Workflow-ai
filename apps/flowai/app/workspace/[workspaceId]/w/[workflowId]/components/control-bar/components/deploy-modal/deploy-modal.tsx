...
export function DeployModal({
  ...
  const handleUndeploy = async () => {
    ...
    try {
      ...
      addNotification(
        "error",
        `Failed to undeploy workflow: ${error.message}`,
        workflowId
      );
    } finally {
  ...
  const handleRedeploy = async () => {
    ...
    try {
      ...
      addNotification(
        "error",
        `Failed to redeploy workflow: ${error.message}`,
        workflowId
      );
    } finally {
      setIsSubmitting(false);
  ...
  const handleChatUndeploy = async () => {
    ...
    try {
      ...
      addNotification(
        "error",
        `Failed to undeploy chat: ${error.message}`,
        workflowId
      );
    } finally {
      setIsUndeploying(false);
              ...
              {chatExists && (
                <AlertDialog>
                  <AlertDialogTrigger asChild>
                    <Button
                      variant="destructive"
                      disabled={chatSubmitting || isUndeploying}
                    >
                      {isUndeploying ? (
                        <>
                          <Loader2 className="mr-1.5 h-3.5 w-3.5 animate-spin" />
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        remove the chat interface and make it unavailable to
                        external users.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
