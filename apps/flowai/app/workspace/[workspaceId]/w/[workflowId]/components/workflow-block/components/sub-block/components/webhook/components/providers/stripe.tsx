  ...
  return (
    <div className="space-y-4">
      ...
      <Alert>
        ...
        <AlertDescription>
          For production use, it's highly recommended to verify Stripe webhook
          signatures to ensure requests are genuinely from Stripe. Visual
          Workflow AI handles this automatically if you provide the signing
          secret during setup (coming soon).
        </AlertDescription>
      </Alert>
    </div>
  );
