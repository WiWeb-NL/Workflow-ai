...
const examplePayload = JSON.stringify(
  {
    content: "Hello from Visual Workflow AI!",
    ...
    <div className="space-y-4">
      <ConfigSection title="Discord Appearance (Optional)">
        ...
        >
          <Input
            ...
            placeholder="Visual Workflow AI Bot"
      ...
      >
        <ol className="list-inside list-decimal space-y-1">
          ...
          <li>
            Paste the copied Discord URL into the main{" "}
            <strong>Webhook URL</strong> field above.
          </li>
          <li>
      ...
      <InstructionsSection title="Sending Messages to Discord (Outgoing via this URL)">
        <p>
          To send messages <i>to</i> Discord using the Visual Workflow AI
          Webhook URL (above), make a POST request with a JSON body like this:
        </p>
        <CodeBlock
          language="json"
          code={examplePayload}
      ...
      <Alert>
        ...
        <AlertDescription>
          The Visual Workflow AI Webhook URL allows sending messages <i>to</i>{" "}
          Discord. Treat it like a password. Don't share it publicly.
        </AlertDescription>
      </Alert>
    </div>
  );
