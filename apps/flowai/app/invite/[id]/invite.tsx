  ...
  const handleAcceptInvitation = async () => {
    ...
    try {
      if (invitationType === "workspace") {
        ...
        const orgId =
          response.data?.invitation.organizationId ||
          invitationDetails?.data?.organizationId;
      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-muted/40 p-4">
        <Card className="w-full max-w-md p-6">
          <CardHeader className="px-0 pt-0 text-center">
            ...
            <CardDescription>
              {isNewUser
                ? "Create an account to join this workspace on Visual Workflow AI"
            ...
            {isNewUser ? (
              <>
                <Button
                  ...
                  onClick={() =>
                    router.push(
                      `/signup?callbackUrl=${callbackUrl}&invite_flow=true`
                    )
                  }
                >
                  Create an account
                ...
                <Button
                  ...
                  onClick={() =>
                    router.push(
                      `/login?callbackUrl=${callbackUrl}&invite_flow=true`
                    )
                  }
                >
      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-muted/40 p-4">
        <Card className="max-w-md space-y-2 p-6 text-center">
          ...
          <p className="text-muted-foreground">
            ...
            {invitationDetails?.name || "the workspace"}. Redirecting to your
            workspace...
          </p>
        </Card>
      </div>
        ...
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-md">
            ...
            <span className="font-medium">
              {invitationDetails?.name || "a workspace"}
            </span>
          </CardDescription>
