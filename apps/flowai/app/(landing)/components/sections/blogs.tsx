  ...
  return (
    ...
    >
      <div className="flex flex-col gap-7">
        ...
        >
          Stay ahead with the latest tips, updates, and best practices for AI
          agent development.
        </motion.p>
      </div>
      ...
      <div className="flex w-full flex-col gap-12 md:grid md:grid-cols-2 md:grid-rows-1 lg:grid-cols-3">
        ...
        >
          <BlogCard
            href="/blog/test"
            title="How to Build an Agent in 5 Steps with flowai-tau.vercel.app"
            description="Learn how to create a fully functional AI agent using flowai-tau.vercel.app's unified API and workflows."
            date={new Date("25 April 2025")}
            author="Emir Ayaz"
            authorRole="Designer"
            avatar="/static/flowai.jpg"
            type="Agents"
            readTime="6"
          />
          <BlogCard
