...
function FeaturesFlow({ nodes, edges }: { nodes: Node[]; edges: Edge[] }) {
  ...
  return (
    <motion.div className="relative h-full w-full" id="features">
      <ReactFlow
        nodes={rfNodes}
        edges={rfEdges}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Unlock the full potential of your agents with intuitive features
          designed to simplify development and maximize impact.
        </motion.p>
      </motion.div>
        ...
        <div className="relative hidden w-full lg:flex">
            ...
            >
              ...
              <defs>
                ...
                >
                  ...
                  <feGaussianBlur
                    stdDeviation="200"
                    result="effect1_foregroundBlur_82_4275"
                  />
                </filter>
              </defs>
            </svg>
          ...
          >
            ...
            <div className="flex w-full flex-1 items-center justify-center">
              <ReactFlowProvider>
                <FeaturesFlow
                  nodes={selectedFeature.nodes}
                  edges={selectedFeature.edges}
                />
              </ReactFlowProvider>
            </div>
          </motion.div>
            ...
            {features.map((f, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {f.feature.icon}
                    <span className="font-semibold text-white/70 text-xl">
                      {f.feature.title}
                    </span>
                  </button>
