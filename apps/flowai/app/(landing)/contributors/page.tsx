        ...
        <section className='px-4 pt-20 pb-12 sm:px-8 sm:pt-28 sm:pb-16 md:px-16 md:pt-40 md:pb-24 lg:px-28 xl:px-32'>
          <div className='mx-auto max-w-6xl'>
            ...
            <div className='mb-12 text-center sm:mb-16'>
              ...
              >
                Meet the amazing people who have helped build and improve Visual Workflow AI
              </motion.p>
            </div>
            ...
            >
              ...
              <div className='mb-6 flex flex-col items-start justify-between gap-3 sm:mb-8 sm:flex-row sm:items-center sm:gap-4'>
                <div className='space-y-1'>
                  <div className='flex items-center gap-2'>
                    <div className='relative h-6 w-6 sm:h-8 sm:w-8'>
                      <Image
                        src='/favicon.ico'
                        alt='Visual Workflow AI Logo'
                        className='object-contain'
                        width={32}
                        height={32}
                      />
                    </div>
                    <h2 className='font-semibold text-lg text-white sm:text-xl'>Visual Workflow AI</h2>
                  </div>
                ...
                <div className='flex gap-2 self-end sm:self-auto'>
                  ...
                  >
                    <a href='https://github.com/visualworkflowaiai/sim' target='_blank' rel='noopener'>
