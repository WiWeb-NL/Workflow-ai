          ...
          <div className='relative px-4 py-4 sm:px-8'>
            ...
            <div className='space-y-8 text-white/80'>
              <section>
                ...
                <p>
                  Please read these Terms of Service ("Terms") carefully before using the Visual Workflow AI
                  platform (the "Service") operated by Visual Workflow AI, Inc ("us", "we", or "our").
                </p>
                <p className='mt-4'>
              ...
              <section>
                ...
                <p className='mb-4'>
                  ...
                  remain the exclusive property of Visual Workflow AI, Inc and its licensors. The Service is
                ...
                <p>
                  ...
                  service without the prior written consent of Visual Workflow AI, Inc.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className='mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]'>
                  ...
                  <li>
                    To impersonate or attempt to impersonate Visual Workflow AI, Inc, a Visual Workflow AI employee,
                  ...
                  <li>
                    ...
                    enjoyment of the Service, or which, as determined by us, may harm Visual Workflow AI,
              ...
              <section>
                ...
                <p className='mb-4'>
                  In no event shall Visual Workflow AI, Inc, nor its directors, employees, partners, agents,
              ...
              <section>
                ...
                <p>
                  Visual Workflow AI, Inc, its subsidiaries, affiliates, and its licensors do not warrant
                  that:
                </p>
                <ul className='mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]'>
                  <li>
              ...
              <section>
                ...
                <p className='mb-4'>
                  ...
                  arbitrate disputes with Visual Workflow AI, Inc, its parent companies, subsidiaries,
                ...
                <p className='mb-4'>
                  ...
                  <Link
                    href='mailto:legal@visualworkflowai.ai'
                    className='text-[#B5A1D4] hover:text-[#701ffc]'
                  >
                    legal@visualworkflowai.ai{' '}
                  </Link>
              ...
              <section>
                ...
                <p>
                  ...
                  <Link
                    href='mailto:copyright@visualworkflowai.ai'
                    className='text-[#B5A1D4] hover:text-[#701ffc]'
                  >
                    copyright@visualworkflowai.ai
                  </Link>
                </p>
              </section>
