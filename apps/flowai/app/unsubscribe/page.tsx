          ...
          <CardContent className="space-y-4">
            <div className="rounded-lg border bg-blue-50 p-4">
              <p className="text-blue-800 text-sm">
                <strong>Transactional emails</strong> like password resets,
                account confirmations, and security alerts cannot be
                unsubscribed from as they contain essential information for your
                account security and functionality.
              </p>
            </div>
      ...
      <div className="flex min-h-screen items-center justify-center bg-background">
        <Card className="w-full max-w-md border shadow-sm">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-muted-foreground">
              You have been unsubscribed from our emails. You will stop
              receiving emails within 48 hours.
            </CardDescription>
          </CardHeader>
      ...
      <Card className="w-full max-w-md border shadow-sm">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-muted-foreground">
            ...
            you&apos;d like to stop receiving from Visual Workflow AI.
          </CardDescription>
