...
export const metadata: Metadata = {
  ...
  metadataBase: new URL('https://visualworkflowai.ai'),
  alternates: {
    canonical: '/',
    languages: {
      'en-US': '/en-US',
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://visualworkflowai.ai/social/facebook.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      'Build and deploy AI agents using our Figma-like canvas. Build, write evals, and deploy AI agent workflows that automate workflows and streamline your business processes.',
    images: ['https://visualworkflowai.ai/social/twitter.png'],
    creator: '@visualworkflowaiai',
    site: '@visualworkflowaiai',
  },
  ...
  return (
    <html lang='en' suppressHydrationWarning>
      <head>
        ...
        <meta name='twitter:image:alt' content='Visual Workflow AI - AI Agent Builder' />
        <meta name='twitter:url' content='https://visualworkflowai.ai' />
        <meta name='twitter:domain' content='visualworkflowai.ai' />

        {/* Additional image sources */}
        <link rel='image_src' href='https://visualworkflowai.ai/social/facebook.png' />
