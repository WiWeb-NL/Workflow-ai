            ...
            <div className="space-y-8 text-white/80">
              <section>
                ...
                <p>
                  ...
                  collected, used, and shared when you visit or use Visual
                  Workflow AI ("the Service", "we", "us", or "our").
                </p>
                <p className="mt-4">
              ...
              <section>
                ...
                <p className="mb-4">
                  Under the following conditions, the meanings of words with
                  capitalized first letters are defined. The following
                  definitions have the same meaning whether they are written in
                ...
                <ul className="mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]">
                  <li>
                    <span className="text-[#B5A1D4]">Account</span> means a
                    unique account created for You to access our Service or
                    parts of our Service.
                  </li>
                  <li>
                    <span className="text-[#B5A1D4]">Affiliate</span> means an
                  ...
                  <li>
                    <span className="text-[#B5A1D4]">Application</span> means
                    the software program provided by the Company downloaded by
                    You on any electronic device.
                  </li>
                  <li>
                    <span className="text-[#B5A1D4]">Business</span>, for the
                    purpose of the CCPA (California Consumer Privacy Act),
                  ...
                  <li>
                    <span className="text-[#B5A1D4]">Company</span> (referred to
                    as either "the Company", "We", "Us" or "Our" in this
                    Agreement) refers to Visual Workflow AI. For the purpose of
                    the GDPR, the Company is the Data Controller.
                  </li>
                  <li>
                    <span className="text-[#B5A1D4]">Cookies</span> are small
                  ...
                  <li>
                    <span className="text-[#B5A1D4]">Country</span> refers to:
                    Quebec, Canada
                  </li>
                  <li>
                    <span className="text-[#B5A1D4]">Data Controller</span>, for
                  ...
                  <li>
                    <span className="text-[#B5A1D4]">Device</span> means any
                    device that can access the Service such as a computer, a
                    cellphone or a digital tablet.
                  </li>
                  <li>
                    <span className="text-[#B5A1D4]">Do Not Track (DNT)</span>{" "}
                  ...
                  <li>
                    <span className="text-[#B5A1D4]">Personal Data</span> is any
                    information that relates to an identified or identifiable
                    individual. For the purposes for GDPR, Personal Data means
                    any information relating to You such as a name, an
                    identification number, location data, online identifier or
                    to one or more factors specific to the physical,
                    physiological, genetic, mental, economic, cultural or social
                    identity. For the purposes of the CCPA, Personal Data means
                  ...
                  <li>
                    <span className="text-[#B5A1D4]">Sale</span>, for the
                    purpose of the CCPA (California Consumer Privacy Act), means
                    ...
                    Consumer's Personal information to another business or a
                    third party for monetary or other valuable consideration.
                  </li>
                  <li>
                    <span className="text-[#B5A1D4]">Service</span> refers to
                    the Application or the Website or both.
                  </li>
                  <li>
                    <span className="text-[#B5A1D4]">Service Provider</span>{" "}
                    ...
                    Company in analyzing how the Service is used. For the
                    purpose of the GDPR, Service Providers are considered Data
                    Processors.
                  </li>
                  <li>
                    <span className="text-[#B5A1D4]">
                  ...
                  <li>
                    <span className="text-[#B5A1D4]">Usage Data</span> refers to
                  ...
                  <li>
                    ...
                    accessing or using the Service, as applicable. Under GDPR
                    (General Data Protection Regulation), You can be referred to
                    as the Data Subject or as the User as you are the individual
                    using the Service.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  <span className="text-[#B5A1D4]">"Personal Information"</span>
                ...
                <p className="mb-4">
                  ...
                  and used (<span className="text-[#B5A1D4]">"Usage Data"</span>
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  including Personal Information, to United States and process
                  it there.
                </p>
                <p>
              ...
              <section>
                ...
                <p className="mb-4">
                  Visual Workflow AI may disclose your Personal Information in
                  the good faith belief that such action is necessary to:
                </p>
                <ul className="list-disc space-y-2 pl-6 marker:text-[#B5A1D4]">
                  <li>To comply with a legal obligation</li>
                  <li>
                    To protect and defend the rights or property of Visual
                    Workflow AI
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  <span className="text-[#B5A1D4]">"Service Providers"</span>),
              ...
              <section>
                ...
                <p className="mb-4">
                  Google Ads remarketing service is provided by Google Inc. You
              ...
              <section>
                ...
                <p className="mb-4">
                  We want to explicitly affirm that any user data obtained
                  through Google Workspace APIs is{" "}
                  <span className="text-[#B5A1D4]">not</span> used to develop,
                  improve, or train generalized AI and/or machine learning
                  models. We use data obtained through Google Workspace APIs
                  solely for the purpose of providing and improving the specific
                  functionality of our Service for which the API access was
                  granted.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mb-4">
                  Visual Workflow AI's use and transfer to any other app of
              ...
              <section>
                <h2 className="mb-4 font-semibold text-2xl text-white">
                  15. Your Data Protection Rights Under General Data Protection
                  Regulation (GDPR)
                </h2>
                <p className="mb-4">
                  If you are a resident of the European Economic Area (EEA), you
                  have certain data protection rights. Visual Workflow AI aims
                  to take reasonable steps to allow you to correct, amend,
                  delete, or limit the use of your Personal Information.
                </p>
                <p className="mb-4">
                  If you wish to be informed what Personal Information we hold
                ...
                <ul className="mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]">
                  ...
                  <li>
                    ...
                    withdraw your consent at any time where Visual Workflow AI
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  <span className="text-[#B5A1D4]">"Shine The Light"</span> law,
                  permits our users who are California residents to request and
                  obtain from us, once a year and free of charge, information
                  about categories of personal information (if any) we disclosed
                  to third parties for direct marketing purposes and the names
              ...
              <section>
                ...
                <p className="mb-4">
                  Visual Workflow AI is dedicated to preserving data security by
                  preventing unauthorized disclosure of information. This policy
                  was created to provide security researchers with instructions
                  for conducting vulnerability discovery activities and to
                  provide information on how to report vulnerabilities that have
                  been discovered. This policy explains which systems and sorts
                  of activity are covered, how to send vulnerability reports,
                  and how long we require you to wait before publicly reporting
                ...
                <ul className="mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]">
                  ...
                  <li>
                    ...
                    vulnerability's presence. Do not use an exploit to
                    compromise or obtain data, establish command line access
                    and/or persistence, or use the exploit to "pivot" to other
                    systems.
                  </li>
                  <li>
                    Once you've established that a vulnerability exists or
                    encounter any sensitive data (including personal data,
                    financial information, or proprietary information or trade
                    secrets of any party), you must stop your test, notify us
                    immediately, and keep the data strictly confidential.
                  </li>
                ...
                <p className="mb-4">
                  Security research carried out in conformity with this policy
                  is deemed permissible. We'll work with you to swiftly
                  understand and fix the problem, and Visual Workflow AI will
                  not suggest or pursue legal action in connection with your
                  study.
                </p>
                ...
                <p className="mb-4">
                  Any service that isn't explicitly specified above, such as
                  related services, is out of scope and isn't allowed to be
                  tested. Vulnerabilities discovered in third-party solutions
                  Visual Workflow AI interacts with are not covered by this
                  policy and should be reported directly to the solution vendor
                ...
                <ul className="mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]">
                  ...
                  <li>
                    ...
                    tailgating), social engineering (e.g., phishing, vishing),
                ...
                <p className="mb-4">
                  In order to process and react to a vulnerability report, we
                ...
                <ul className="mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]">
                  ...
                  <li>
                    Steps required to reproduce a vulnerability (include scripts
                ...
                <p className="mb-4">
                  If you choose to give your contact information, we promise to
                  communicate with you in a transparent and timely manner. We
                  will acknowledge receipt of your report within three business
                  days. We will keep you informed on vulnerability confirmation
                  and remedy to the best of our capabilities. We welcome a
                  discussion of concerns and are willing to engage in a
                  discourse.
                </p>
              </section>
