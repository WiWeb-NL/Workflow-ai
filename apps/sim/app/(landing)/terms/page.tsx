            ...
            <div className="space-y-8 text-white/80">
              <section>
                ...
                <p>
                  ...
                  using the Visual Workflow AI platform (the "Service") operated
                  by Visual Workflow AI, Inc ("us", "we", or "our").
                </p>
                <p className="mt-4">
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  Visual Workflow AI, Inc and its licensors. The Service is
              ...
              <section>
                ...
                <ul className="mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]">
                  <li>
                    The User Content is yours (you own it) or you have the right
                    to use it and grant us the rights and license as provided in
                    these Terms.
                  </li>
                  <li>
                    The posting of your User Content on or through the Service
              ...
              <section>
                ...
                <ul className="mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]">
                  ...
                  <li>
                    To impersonate or attempt to impersonate Visual Workflow AI,
                    Inc, a Visual Workflow AI employee, another user, or any
                  ...
                  <li>
                    ...
                    determined by us, may harm Visual Workflow AI, Inc or users
              ...
              <section>
                ...
                <p className="mb-4">
                  In no event shall Visual Workflow AI, Inc, nor its directors,
              ...
              <section>
                ...
                <p>
                  Visual Workflow AI, Inc, its subsidiaries, affiliates, and its
              ...
              <section>
                ...
                <p className="mb-4">
                  Please read the following arbitration agreement carefully. It
                  requires you to arbitrate disputes with Visual Workflow AI,
                  Inc, its parent companies, subsidiaries, affiliates,
                  successors and assigns and all of their respective officers,
                  directors, employees, agents, and representatives
                  (collectively, the{" "}
                  <span className="text-[#B5A1D4]">"Company Parties"</span>) and
                  limits the manner in which you can seek relief from the
                  Company Parties.
                </p>
                <p className="mb-4">
                  You agree that any dispute between you and any of the Company
                  Parties relating to the Site, the Service or these Terms will
                  be resolved by binding arbitration, rather than in court,
                  except that (1) you and the Company Parties may assert
                  individualized claims in small claims court if the claims
                  qualify, remain in such court and advance solely on an
                  individual, non-class basis; and (2) you or the Company
                  Parties may seek equitable relief in court for infringement or
                ...
                <p className="mb-4 border-[#701ffc] border-l-4 bg-[#701ffc]/10 p-3">
                  ...
                  REPRESENTATIVE, OR COLLECTIVE BASIS. ONLY INDIVIDUAL RELIEF IS
                  AVAILABLE, AND DISPUTES OF MORE THAN ONE CUSTOMER OR USER
              ...
              <section>
                ...
                <p className="mb-4">
                  ...
                  users of our Service do the same. If you believe that one of
                  our users is, through the use of our Service, unlawfully
                  infringing the copyright(s) in a work, please send a notice to
                  our designated Copyright Agent, including the following
                  information:
                </p>
                <ul className="mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]">
                  ...
                  <li>
                    A statement, made under the penalty of perjury, that the
