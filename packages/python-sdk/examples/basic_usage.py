#!/usr/bin/env python3
"""
Basic usage examples for the Visual Workflow AI Python SDK
"""
...
if __name__ == "__main__":
    print("🚀 Running Visual Workflow AI Python SDK Examples\n")
    
    # Check if API key is set
    if not os.getenv("visualworkflowai_API_KEY"):
        print("❌ Please set visualworkflowai_API_KEY environment variable")
        exit(1)
